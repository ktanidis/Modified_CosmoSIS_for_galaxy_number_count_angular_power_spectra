...
<img src="https://render.githubusercontent.com/render/math?math=W_{g,RSD} ^{A,i}(k_\ell,\chi)=\frac{2\ell^2+2\ell-1}{(2\ell-1)(2\ell+3)}\left[N_A^i(\chi)\right]\Big\{\left[fD\right](k_\ell,\chi)\Big\} 
    -\frac{(\ell-1)\ell}{(2\ell-1)\sqrt{(2\ell-3)(2\ell+1)}}\left[N_A^i (\chi)\right]\Bigg\{\left[ fD\right]\left(k_\ell,\frac{2\ell-3}{2\ell+1}\chi\right)\Bigg\}
    -\frac{(\ell+1)(\ell+2)}{(2\ell+3)\sqrt{(2\ell+1)(2\ell+5)}}\left[N_A^i(\chi)\right] \Bigg\{\left[fD\right]\left(k_\ell,\frac{2\ell+5}{2\ell+1}\chi\right)\Bigg\}">
